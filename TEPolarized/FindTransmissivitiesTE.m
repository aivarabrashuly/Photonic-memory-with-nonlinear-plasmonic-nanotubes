function [tauplus1, tauminus1] = FindTransmissivitiesTE(gn0, xn0E02, k0a)
...
GA1       = (1+(F1/k0a^2)^2*(k0a^2*gn0+xn0E02*(2*tauplus+tauminusA)).^2).*tauminusA-1;
GB1       = (1+(F1/k0a^2)^2*(k0a^2*gn0+xn0E02*(2*tauplus+tauminusB)).^2).*tauminusB-1;
